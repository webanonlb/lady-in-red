    ...
    <section className="relative min-h-[80vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Lady in Red — Just Married wedding exit on a candle-lit drive"
          fill
          sizes="100vw"
      ...
      <div className="relative z-10 text-center px-5 max-w-4xl py-32">
        ...
        <h2 className="headline mt-8 text-[40px] sm:text-6xl lg:text-[88px]">
          Your moment <em>starts here.</em>
        </h2>
        <p className="mt-6 text-cream/80 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
          Weddings, videos, private events, and timeless memories — framed
          by Beirut’s red classic.
        </p>
